...
class LandRegistry(ARC4Contract):
    ...
    def get_land(
        self,
        land_id: UInt64,
    ) -> tuple[String, UInt64, Bytes, UInt64]:
        """
        Retrieve a land record.
    ...
    def verify_land(
        ...
        """
        Mark a land parcel as verified.
    ...
    def get_verification_status(
        ...
        """
        Return land verification status.
        """
    ...
    def get_boundary(
        self,
        boundary_id: UInt64,
    ) -> tuple[UInt64, UInt64, Bytes, UInt64]:
        """
